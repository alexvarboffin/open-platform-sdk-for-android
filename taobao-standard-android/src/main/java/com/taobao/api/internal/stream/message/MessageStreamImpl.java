...
/**
 * 
 * @author zhenzi 2011-8-12 上午10:05:00
 */
public class MessageStreamImpl extends AbstractStreamImpl {
	private static final String TAG = "MessageStreamImpl";
	// private static final Logger logger =
	// Logger.getLogger(MessageStreamImpl.class);
	...
	public MessageStreamImpl(StreamMsgConsumeFactory msgConsumeFactory,
			HttpResponse response, TopCometMessageListener msgListener,
			ControlThread ct) {
	...
	public String parseLine(String msg) throws TopCometException, IOException {
		if (!StringUtils.isEmpty(msg)) {
			try {
				...
				Log.e(TAG, "Message is invalid:" + msg, e);
