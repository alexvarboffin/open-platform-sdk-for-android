...
public abstract class JushitaConfiguration extends Configuration {
	private String url = "http://synccenter.taobao.com/message/sub";
	...
	private class JushitaConnectionLifeCycleListener implements ConnectionLifeCycleListener {
		...
		public void onConnect() {
			if (JushitaConfiguration.this.connectionLifeCycleListener != null) {
				JushitaConfiguration.this.connectionLifeCycleListener.onConnect();
			}
		}
		...
		public void onConnectError(Exception e) {
			if (JushitaConfiguration.this.connectionLifeCycleListener != null) {
				JushitaConfiguration.this.connectionLifeCycleListener.onConnectError(e);
			}
		}
		
		public void onReadTimeout() {
			if (JushitaConfiguration.this.connectionLifeCycleListener != null) {
				JushitaConfiguration.this.connectionLifeCycleListener.onReadTimeout();
			}
		}
		...
		public void onSysErrorException(Exception e) {
			if (JushitaConfiguration.this.connectionLifeCycleListener != null) {
				JushitaConfiguration.this.connectionLifeCycleListener.onSysErrorException(e);
			}
		}
	}
}
