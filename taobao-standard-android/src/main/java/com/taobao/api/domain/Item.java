...
public class Item extends TaobaoObject {
	...
	private static final long serialVersionUID = 4559874189936596999L;
...
如果有效期为天数类型则格式为3
	 */
	@ApiField("etc_delivery_way")
	private String etcDeliveryWay;
...
taobao.items.search和taobao.items.vip.search专用
	...
	public String getEtcDeliveryWay() {
		return this.etcDeliveryWay;
	}
	public void setEtcDeliveryWay(String etcDeliveryWay) {
